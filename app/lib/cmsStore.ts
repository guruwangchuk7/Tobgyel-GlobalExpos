...
export const INITIAL_CONTACT: ContactConfigCMS = {
  ...
  phonePrimary: "+975 17 12 34 56",
  phoneSecondary: "+975 77 98 76 54",
  emailGeneral: "info@tobgyelglobalexpos.bt",
  emailSupport: "support@tobgyelglobalexpos.bt",
  websiteUrl: "www.tobgyelglobalexpos.bt",
